      ...
      <motion.div initial={{ opacity: 0, x: -12 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }}
        ...
        <div>
          <h1 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 800, fontSize: '1.75rem', color: theme.textPrimary, marginBottom: 4 }}>
            CUF Implementation Bottlenecks
          </h1>
          <p style={{ color: theme.textMuted, fontSize: '0.85rem' }}>
            {issues.length} active field audit alerts & statutory clearance bottlenecks tracked across Central Sector Projects
          </p>
        </div>
        <div style={{ display: 'flex', gap: 8 }}>
          <Link to="/report" style={{ textDecoration: 'none' }}>
            <GlowButton variant="primary" size="sm" icon={<AlertTriangle size={14} />}>Log Field Bottleneck</GlowButton>
          </Link>
        </div>
      </motion.div>
