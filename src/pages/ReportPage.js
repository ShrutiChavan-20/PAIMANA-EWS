...
const categories = [
  ...
  'Contractor Liquidity Default',
  'Right of Way (RoW) Obstruction',
  'Fund Flow / Grant Delay',
  'Geological / Strata Surprise',
  'Law & Order / Local Protest',
...
const categoryIcons = {
  'Land Acquisition Dispute': MapPin,
  'Forest & Env Clearance': CloudRain,
  'Utility Relocation Delay': Droplet,
  'Contractor Liquidity Default': DollarSign,
  'Right of Way (RoW) Obstruction': AlertTriangle,
  'Fund Flow / Grant Delay': ShieldAlert,
  'Geological / Strata Surprise': Clock,
  'Law & Order / Local Protest': Volume2,
  'Supply Chain & Material Shortage': Trash2,
  'Inter-Ministerial Approvals': HelpCircle
};

const categoryDesc = {
  'Land Acquisition Dispute': 'High court stay orders, compensation litigation, parcel delays',
  'Forest & Env Clearance': 'Pending Stage-I / Stage-II forest diversion, MoEFCC wildlife clearance',
  'Utility Relocation Delay': 'Power transmission line, water pipeline, or rail track shifting',
  'Contractor Liquidity Default': 'Financial insolvency, slow plant mobilization, subcontractor disputes',
  'Right of Way (RoW) Obstruction': 'Encroachments preventing continuous strip execution',
  'Fund Flow / Grant Delay': 'Delayed state matching share, bank guarantee bottlenecks',
  'Geological / Strata Surprise': 'Unforeseen hard rock strata, tunnel water ingress, seismic faults',
  'Law & Order / Local Protest': 'Work stoppage due to local agitations or security clearances',
  'Supply Chain & Material Shortage': 'Ballast, high-grade steel, turbine imports, or cement escalation',
  'Inter-Ministerial Approvals': 'Defence, civil aviation, or railway safety commissioner sanctions'
};

const steps = ['Bottleneck Type', 'Project Details', 'Risk Level', 'CUF Verification'];
  ...
  return (
    <AnimatedPage style={{ padding: '1.5rem', maxWidth: 1100, margin: '0 auto' }}>
      <motion.div initial={{ opacity: 0, x: -12 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.3 }} style={{ marginBottom: '1.5rem' }}>
        <h1 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 800, fontSize: '1.75rem', color: theme.textPrimary }}>Report Implementation Bottleneck</h1>
        <p style={{ color: theme.textMuted, fontSize: '0.82rem', marginTop: 4 }}>PAIMANA Field Verification & CUF Audit · Geo-tagged · AI-classified · Real-time MoSPI Early Warning Sync</p>
      </motion.div>
